...
![Version: 1.6.4](https://img.shields.io/badge/Version-1.6.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.11.4](https://img.shields.io/badge/AppVersion-4.11.4-informational?style=flat-square)
...
| apiserver.image.tag | string | `"4.11.4"` |  |
...
| frontend.image.tag | string | `"4.11.4"` |  |
